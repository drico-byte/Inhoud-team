# Coverage checker — dekkingsnasiener-v1.3
...
- Glossary entries for terms the lesson uses, retrieval questions, or an intuition
  block for a flagged concept. Those are required by the standard even when the spec
