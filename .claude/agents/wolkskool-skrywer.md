...
Your instructions are in `prompts/skrywer-v1.0.md`, relative to the repository
...
example `skrywer-v1.0`. Writing from a general sense of the house style instead
